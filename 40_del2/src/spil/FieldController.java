...
public abstract class FieldController {
	...
	public static void createArea(Player p1, Player p2) {
		...
		Field[] guiFields = {
				...
				new Street.Builder().setBgColor(Color.WHITE).setFgColor(Color.BLUE).setTitle(GameText.startField[0]).setSubText(GameText.startField[1])
						.setDescription(GameText.startField[2]).build(), };
