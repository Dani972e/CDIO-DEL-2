...
public abstract class FieldController {
	...
	public static void createArea(Player p1, Player p2) {
		spil.Field[] fields = {
				new spil.Field(new Color(0x46B50A), new Color(0xFFFFFF), TextController.field2Text[0], TextController.field2Text[1], TextController.field2Text[2], 250),
				new spil.Field(new Color(0xBA8F71), new Color(0x000000), TextController.field3Text[0], TextController.field3Text[1], TextController.field3Text[2], -100),
				new spil.Field(new Color(0xAF0EA7), new Color(0x68DBFF), TextController.field4Text[0], TextController.field4Text[1], TextController.field4Text[2], 100),
				new spil.Field(new Color(0x89BEFF), new Color(0x000000), TextController.field5Text[0], TextController.field5Text[1], TextController.field5Text[2], -20),
				new spil.Field(new Color(0xF4E242), new Color(0x1000FF), TextController.field6Text[0], TextController.field6Text[1], TextController.field6Text[2], 180),
				new spil.Field(new Color(0xFFF6B7), new Color(0x00B5AF), TextController.field7Text[0], TextController.field7Text[1], TextController.field7Text[2], 0),
				new spil.Field(new Color(0x877E79), new Color(0x820707), TextController.field8Text[0], TextController.field8Text[1], TextController.field8Text[2], -70),
				new spil.Field(new Color(0xFF9900), new Color(0x155B00), TextController.field9Text[0], TextController.field9Text[1], TextController.field9Text[2], 60),
				new spil.Field(new Color(0xE2E2E2), new Color(0xE00000), TextController.field10Text[0], TextController.field10Text[1], TextController.field10Text[2], -80),
				new spil.Field(new Color(0xC61300), new Color(0xFF7575), TextController.field11Text[0], TextController.field11Text[1], TextController.field11Text[2], -50),
				new spil.Field(new Color(0xFFD700), new Color(0xCC7000), TextController.field12Text[0], TextController.field12Text[1], TextController.field12Text[2], 650),
		};
